    ...
    return (
        <div className="min-h-[60vh] flex items-center justify-center px-4" dir="rtl">
            <div className="text-center max-w-md">
                ...
                <h2 className="text-xl font-bold text-fg mb-2">حدث خطأ في لوحة الإدارة</h2>
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                    ...
                    <Link href="/" className="py-2.5 px-6 border border-white/20 rounded-xl text-fg/70 hover:bg-white/5 text-sm transition-colors">
                        الصفحة الرئيسية
                    </Link>
                ...
                {error?.digest && (
                    <p className="mt-6 text-xs text-fg/30 font-mono">رمز: {error.digest}</p>
                )}
            </div>
        </div>
    );
